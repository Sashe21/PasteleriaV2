  ...
  const allPastries = [
    {
      ...
      description: "Un clásico irresistible con capas de bizcocho de chocolate y ganache de chocolate belga.",
      price: "25.00",
    ...
    },
    {
      ...
      description: "Delicada tarta con crema pastelera ligera y fresas frescas de temporada, sobre una base crujiente.",
      price: "28.50",
      imageUrl: "/placeholder.svg",
    ...
    },
    {
      ...
      description: "Cremoso cheesecake horneado con una capa generosa de salsa de arándanos casera y un toque cítrico.",
      price: "30.00",
      imageUrl: "/placeholder.svg",
